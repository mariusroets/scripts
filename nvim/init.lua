...
require('lazy').setup({
  ...
  -- bufferline.nvim provides improved bufferline
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'typescript', 'vimdoc', 'vim', 'css', 'scss', 'javascript', 'json', 'xml', 'toml', 'html', 'htmldjango', 'rst', 'yaml' },
